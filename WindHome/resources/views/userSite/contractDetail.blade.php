                    ...
                    @if($room->statusId==3)
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <a href="{{route('UserAction.cancelBookingRequest',['roomId'=> $room->id,'contractId'=>$contractId] )}}"
                    ...
                    @elseif($room->statusId==2)
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <a href="{{route('UserAction.cancelRoom',['roomId'=> $room->id,'contractId'=>$contractId] )}}"
